...
function addMessage(role,text,meta=''){
  ...
  wrap.appendChild(inner);messagesEl.appendChild(wrap);return bubble;
}
...
$('#newChatBtn').onclick=()=>{window.dispatchEvent(new CustomEvent('velora:new-chat'));history=[];lastAssistantText='';messagesEl.innerHTML='<div class="welcome"><div class="orb"></div><div class="eyebrow" style="margin-top:18px">VELORA X ONLINE</div><h2>Pick a model. Create.</h2><p>Use the provider and model selectors, then chat.</p></div>';promptEl.value='';if(pendingAttachment){pendingAttachment=null;if(fileInput)fileInput.value='';renderAttachmentBar();}};
$('#clearBtn').onclick=()=>{history=[];lastAssistantText='';messagesEl.innerHTML='<div class="welcome"><div class="orb"></div><div class="eyebrow" style="margin-top:18px">VELORA X ONLINE</div><h2>Pick a model. Create.</h2><p>Use the provider and model selectors, then chat.</p></div>';promptEl.value='';if(pendingAttachment){pendingAttachment=null;if(fileInput)fileInput.value='';renderAttachmentBar();}};
